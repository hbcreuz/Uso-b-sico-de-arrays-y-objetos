document.write(`<h1>Estadistícas Centro Médico Ñuñoa</h1><hr>`)
...
document.write(`<p>Primera atención : ${radiologia[0].paciente} - ${radiologia[0].prevision} | Última atención ${radiologia[4].paciente} - ${radiologia[4].prevision}</p>`)
document.write(`<h4> Primera y última atención Traumatología</h4>`)
document.write(`<p>Primera atención : ${traumatologia[0].paciente} - ${traumatologia[0].prevision} | Última atención ${traumatologia[4].paciente} - ${traumatologia[4].prevision}</p>`)
document.write(`<h4> Primera y última atención Dental</h4>`)
document.write(`<p>Primera atención : ${dental[0].paciente} - ${dental[0].prevision} | Última atención ${dental[5].paciente} - ${dental[5].prevision}</p>`)